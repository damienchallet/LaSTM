...
@keras_export('keras.experimental.PeepholeVLSTMCell')
class PeepholeVLSTMCell(VLSTMCell):
    ...
    def __init__(self,
        ...
        warnings.warn('`tf.keras.experimental.PeepholeLSTMCell` is deprecated '
                      ...
                      'instead.')
        super(PeepholeVLSTMCell, self).__init__(
            units=units,
            activation=activation,
    ...
    def build(self, input_shape):
        super(PeepholeVLSTMCell, self).build(input_shape)
    ...
    def _compute_carry_and_output(self, x, h_tm1, c1_tm1 , c2_tm1):
        ...
        print("peephole VLSTM, what am I doing here ?")
        return c, o
...
@keras_export(v1=['keras.layers.VLSTM'])
class VLSTM(RNN):
    ...
    def get_config(self):
        ...
        config.update(_config_for_enable_caching_device(self.cell))
        base_config = super(VLSTM, self).get_config()
        del base_config['cell']
        return dict(list(base_config.items()) + list(config.items()))
